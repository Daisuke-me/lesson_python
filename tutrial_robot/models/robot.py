...
from tutrial_robot.models import ranking
from tutrial_robot.views import console
...
class Robot:
    ...
    def hello(self):
        """Returns words to the user that the robot speaks at the beaning"""
        while True:
...
class RestaurantRobot(Robot):
    ...
    def recommend_restaurant(self):
        """show restaurant recommended restaturant to the user"""
        ...
        while True:
            ...
            is_yes = input(template.substitue({
                'robot_name': self.name,
